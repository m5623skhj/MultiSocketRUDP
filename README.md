...
기존 수동 측정 조건과 결과는 [RTT 측정 이슈](https://github.com/m5623skhj/MultiSocketRUDP/issues/185#issuecomment-4670917398)를 참고합니다. 아래 그래프는 `main`에 기록된 최근 10회 공식 측정의 반복 중앙값을 보여주며, 그래프 아래 표에는 측정 날짜(UTC), 커밋 로그, P95/P99 RTT(ms)가 함께 표시됩니다. 첫 자동 측정이 완료된 이후 표시됩니다.
