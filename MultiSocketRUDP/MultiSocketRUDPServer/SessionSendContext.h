...
public:
	...
	// ----------------------------------------
	// @brief 캐시된 시퀀스 벡터에 대한 참조를 반환합니다.
...
private:
	...
	std::vector<MultiSocketRUDP::PacketSequenceSetKey> cachedSequences;
	static constexpr size_t CACHED_SEQUENCE_SET_INITIAL_CAPACITY = 32;
