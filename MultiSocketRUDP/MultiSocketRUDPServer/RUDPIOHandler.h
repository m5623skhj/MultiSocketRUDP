...
private:
	...
	[[nodiscard]]
	SEND_PACKET_INFO_TO_STREAM_RETURN ReservedSendPacketInfoToStream(OUT RUDPSession& session, OUT std::vector<MultiSocketRUDP::PacketSequenceSetKey>& packetSequences, OUT unsigned int& totalSendSize, ThreadIdType threadId) const;
	[[nodiscard]]
	SEND_PACKET_INFO_TO_STREAM_RETURN StoredSendPacketInfoToStream(OUT RUDPSession& session, OUT std::vector<MultiSocketRUDP::PacketSequenceSetKey>& packetSequences, OUT unsigned int& totalSendSize, ThreadIdType threadId) const;
