...
std::vector<MultiSocketRUDP::PacketSequenceSetKey>& RUDPSessionFunctionDelegate::GetCachedSequences(RUDPSession& session)
{
	return session.GetSendContext().GetCachedSequences();
}
